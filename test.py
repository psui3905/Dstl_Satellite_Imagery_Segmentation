...
activation 	=	"leaky_relu" 		# Activation function for conv layers "elu", "relu", "Leaky_relu"
...
model_path	=	"./training_data_cross_jac_7blk_stretch_8bit_leaky_relu/highest_"
output_path	= 	"./Results"
...
for image_id in test_ids:
    ...
    new_mask = predicted_mask    

    print(predicted_mask.shape)
    #print(image_id)
    #predicted_mask = read_GT_Masks(image_id, 11, -1)
